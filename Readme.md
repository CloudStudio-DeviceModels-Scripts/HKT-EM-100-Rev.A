...
# Parsing + Configuration Script – HKT-EM-100 - Rev. A

This **Parsing + Configuration** script is designed for the **HKT-EM-100** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – HKT-EM-100 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **HKT-EM-100** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
