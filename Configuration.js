...
function getEndpoints(deviceAddress, endpoints) {
    var energy = endpoints.addEndpoint("1", "Total energy", endpointType.genericSensor);
     energy.variableTypeId = 1292;
    var amount = endpoints.addEndpoint("2", "Amount", endpointType.genericSensor);
    amount.variableTypeId = 1286;
    endpoints.addEndpoint("3", "A phase voltage", endpointType.voltageSensor);
    endpoints.addEndpoint("4", "B phase voltage", endpointType.voltageSensor);
    endpoints.addEndpoint("5", "C phase voltage", endpointType.voltageSensor);
    endpoints.addEndpoint("6", "A phase current", endpointType.currentSensor);
    endpoints.addEndpoint("7", "B phase current", endpointType.currentSensor);
    endpoints.addEndpoint("8", "C phase current", endpointType.currentSensor);
    endpoints.addEndpoint("9", "Device status", endpointType.iasSensor);
    endpoints.addEndpoint("10", "Alarm", endpointType.iasSensor, iasEndpointSubType.alarmInput);
